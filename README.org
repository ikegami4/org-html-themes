...
The main difference between this fork and original is that bigblow theme of this fork version does not have mini toc and dashboard.

https://ikegami4.bitbucket.io/ uses biglow theme of this fork version.
